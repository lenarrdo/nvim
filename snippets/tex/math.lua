...
return {
	...
	-- parentesi e moduli
	autosnippet({ trig = "lrm" }, fmta("\\left|{<>}\\right|<>", { i(1), i(0) }), { condition = in_mathzone }),
	autosnippet({ trig = "lrt" }, fmta("\\left({<>}\\right)<>", { i(1), i(0) }), { condition = in_mathzone }),
	autosnippet({ trig = "lrq" }, fmta("\\left[{<>}\\right]<>", { i(1), i(0) }), { condition = in_mathzone }),
	autosnippet({ trig = "lrg" }, fmta("\\left\\{{<>}\\right\\}<>", { i(1), i(0) }), { condition = in_mathzone }),
	autosnippet({ trig = "lra" }, fmta("\\langle{<>}\\rangle<>", { i(1), i(0) }), { condition = in_mathzone }),
	...
	autosnippet({ trig = "log" }, fmta("\\log_{<>}(<>)<>", { i(1), i(2), i(0) }), { condition = in_mathzone }),
	...
	autosnippet({ trig = "oli" }, fmta("\\overline{<>}<>", { i(1, "x"), i(0) }), { condition = in_mathzone }),
	autosnippet(
		{ trig = "uset" },
		fmta("\\underset{<>}{<>}<>", { i(1, "sotto"), i(2, "sopra"), i(0) }),
		{ condition = in_mathzone }
	),
	autosnippet({ trig = "sq" }, fmta("\\sqrt{<>}<>", { i(1, "x"), i(0) }), { condition = in_mathzone }),
	autosnippet(
		{ trig = "rt" },
